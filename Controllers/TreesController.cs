...
namespace AdvancedProgramming_Lesson1.Controllers
{
    ...
    {
        private readonly MvcTreeContext _context;

        public TreesController(MvcTreeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Height,TreeType,PlantDate,Diameter,LeafColor")] Tree tree)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Height,TreeType,PlantDate,Diameter,LeafColor")] Tree tree)
        {
            if (id != tree.Id)
            {
                return NotFound();
