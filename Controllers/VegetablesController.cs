...
namespace AdvancedProgramming_Lesson1.Controllers
{
    ...
    {
        private readonly MvcVegetablesContext _context;

        public VegetablesController(MvcVegetablesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,VeggieType,PlantDate,HarvestDate,Weight,Price")] Vegetables vegetables)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VeggieType,PlantDate,HarvestDate,Weight,Price")] Vegetables vegetables)
        {
            if (id != vegetables.Id)
            {
                return NotFound();
