...
namespace AdvancedProgramming_Lesson1.Controllers
{
    ...
    {
        private readonly MvcMeatContext _context;

        public MeatsController(MvcMeatContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ExpirationDate,MeatType,Weight,FatPercetage,Price")] Meat meat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ExpirationDate,MeatType,Weight,FatPercetage,Price")] Meat meat)
        {
            if (id != meat.Id)
            {
                return NotFound();
